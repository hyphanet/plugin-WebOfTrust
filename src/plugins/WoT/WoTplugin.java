 ...
 */
public class WoTplugin implements FredPlugin, FredPluginHTTP, FredPluginThreadless, FredPluginFCP, FredPluginVersioned, FredPluginL10n {
	...
	public void runPlugin(PluginRespirator pr) {
		...
		inserter = new IdentityInserter(wot, db, client, pr.getNode().clientCore.tempBucketFactory);
	...
	private SimpleFieldSet handleGetIdentitiesByScore(SimpleFieldSet params) throws InvalidParameterException, MalformedURLException, UnknownIdentityException, DuplicateIdentityException {
		...
		ObjectSet<Score> result = wot.getIdentitiesByScore(params.get("TreeOwner"), params.get("Select").trim());
