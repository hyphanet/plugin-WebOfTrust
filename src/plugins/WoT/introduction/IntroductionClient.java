...
public final class IntroductionClient extends TransferThread  {
	...
	private synchronized void downloadPuzzles() {
		...
		final ArrayList<Identity> identitiesToDownloadFrom = new ArrayList<Identity>(newRequestCount + 1);
